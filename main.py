...
#student button
        ...
        img5=Image.open(r"C:\Users\sulthana safeer\Desktop\face_recognition_system\images\patientdetails.jpg")
        img5=img5.resize((263,175),Image.LANCZOS)              
        self.PhotoImage5=ImageTk.PhotoImage(img5)

        b1=Button(bg_img,image=self.PhotoImage5,command= self.patient_details,cursor= "hand2")
        b1.place(x=200,y=100,width=263,height=175)



        b1_1=Button(bg_img,text = "Patient Details",command=self.patient_details, cursor= "hand2", font= ("times new roman",15,), bg ="white", fg="Gray")
        b1_1.place(x=200,y=250,width=264,height=40)
